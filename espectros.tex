...
\TODO{¿Todas nos ayudan a ver qué pasa
...
Observe que estamos
usando los parámetros de las rectas
de mínimos cuadrados para
\TODO{aaa}, pero para terminar veamos si al menos
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[scale = 0.4]{./graficas_analisisEspectrales/k_3} 
\end{figure}
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[scale = 0.3]{./graficas_analisisEspectrales/k_20} 
\end{figure}
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[scale = 0.3]{./graficas_analisisEspectrales/k_40} 
\end{figure}
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[scale = 0.3]{./graficas_analisisEspectrales/k_47} 
\end{figure}
