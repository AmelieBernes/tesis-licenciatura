...
en \url{https://github.com/AmelieBernes/tesis-licenciatura/tree/main}. \\
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[scale = 0.4]{./estudios_espectrales/ejemplo_pregunta3_1} 
\end{figure}	
...
esta vez para analizar algunos PDL. 
...
\marginnote{Calculamos una sola vez y guardamos los datos
necesarios para dibujar estas gráficas con el módulo \texttt{pickle} de python.}
...
se han guardado en 
\url{https://github.com/AmelieBernes/tesis-licenciatura/tree/main/imagenes/graficas_analisisEspectrales}.
...
Observe que las frecuencias que maximizan los
coeficientes espectrales $\Sigma_{\cali{L}^{n,1}}$
de los 
PDL de grado $1$ son todas cero, pues
como $\cali{L}^{n,1}$ es elemento de $W_{n,1}$, 
coincide con su proyección a este espacio, luego,
\[
\Sigma_{\cali{L}^{n,1}}(0) =
cos(\measuredangle(\cali{L}^{n,1}, W_{n,1})) = 
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[scale = 0.45]{./graficas_analisisEspectrales/39_5} 
\end{figure}	
\begin{figure}[H]
	\sidecaption{
	Análisis espectral de
	...
	\centering
	\includegraphics[scale = 0.45]{./graficas_analisisEspectrales/39_8} 
\end{figure}	
\begin{figure}[H]
	\sidecaption{
	Análisis espectral de
	...
	\centering
	\includegraphics[scale = 0.45]{./graficas_analisisEspectrales/39_15} 
\end{figure}	
\begin{figure}[H]
	\sidecaption{
	Análisis espectral de
	...
	\centering
	\includegraphics[scale = 0.45]{./graficas_analisisEspectrales/39_38} 
\end{figure}	
...
para dimensiones $0 \leq n \leq 69$, se han guardado en 
\url{https://github.com/AmelieBernes/tesis-licenciatura/tree/main/imagenes/graficas_analisisEspectrales}.
...
$m_{n,0}$ y $m_{n,1}$ se encontraran, para toda $n$,
cercanas a $0.5$, mientras que las ordenadas al origen
$b_{n,0}$ y $b_{n,1}$ se ubicaran cerca de cero. Lo que en realidad
