...
por completitud de este trabajo, pues planeamos usar
la transformada discreta de Fourier para hacer un análisis
espectral inicial de los PDL. Puede consultar referencias con
información detallada en \TODO{cita más referencias!}}
de $\IC^{n}$
...
\marginnote{Según las ecuaciones \ref{eq0: 25Ap}
y \ref{eq1: 25Ap}, los coeficientes $\tau_{n, \omega}(x)$
permiten calibrar la presencia de la frecuencia $\omega$
(en los rangos dados por las tablas 
\ref{Tab: frecuencias TDF n impar} y
\ref{Tab: frecuencias TDF n par})
en una señal $x$.}
