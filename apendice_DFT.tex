...
\TODO{Mucho antes tienes que definir el prodcuto punto en $\IC^{n}$, tal
vez justo al inicio, cuando definas prod. punto.}


La definición de la función exponencial compleja 
tiene diversas motivaciones, puede consultar 
\cite{marsden} para conocer algunas de ellas; nosotros sólo
