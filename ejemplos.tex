...
\centering\captionsetup{format = hang}
	\begin{measuredfigure}
		\includegraphics[scale=0.32]{graficasLegendre3} 
...
\centering\captionsetup{format = hang}
	\begin{measuredfigure}
		\includegraphics[scale=0.3]{graficaX_31Oct} 
...
\centering\captionsetup{format = hang}
	...
	qué tan afín es una señal $x$. \TODO{cambia nombres.}}
 	\end{measuredfigure}
 \end{figure}
