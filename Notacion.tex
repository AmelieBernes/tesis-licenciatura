...
\noindent
 ...
 $\%$ \hbox to\linewidth{\hfil \TODO{módulo} \hfil} \\
 ...
 $\cali{C}[a,b]$ \hbox to\linewidth{\hfil Conjunto de funciones continuas en $[a,b]$ \hfil}   \\
 $\IR^{+}_{0}$ \hbox to\linewidth{\hfil Conjunto de los números reales no negativos \hfil}  \\
 $a \IZ$ \hbox to\linewidth{\hfil Conjunto $\{a z: \hspace{0.2cm} x \in \IZ \}$. \hfil}  \\
