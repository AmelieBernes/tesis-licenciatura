...
\footnote{Puede recordar la definición
...
\centering\captionsetup{format = hang}
	\begin{measuredfigure}
		\includegraphics[scale=0.6]{2Dic_1} 
		\caption{Partimos del conjunto
		de cinco puntos
		$
		G=\{ (0, 5), (1,3.2), (2, 4.6),
		(3,0), (4, -0.3) \}
...
\centering\captionsetup{format = hang}
	\begin{measuredfigure}
		\includegraphics[scale=0.6]{2Dic_2} 
		\caption{
		\TODO{cambia nombre del espacio $W_{n}$}		
		El vector formado a partir
		del conjunto $G$ 
		introducido en la imagen
		\ref{fig: rmc}
