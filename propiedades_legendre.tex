...
\TODO{Poner aquí un esquema de la señal y agregar un poco de ruido;
decir que, como la distancia euclidea no será mucha, es normal
suponer que el grado de ambas señales puede ser el mismo.}
%-----------------------------------------------------
