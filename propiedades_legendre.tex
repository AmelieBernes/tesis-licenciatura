\chapter{Análisis de señales finitas en base a coeficientes respecto a las BLD}
\TODO{Esto va a ser ahora un capítulo entero, y muy importante.}
...
\marginnote{Los productos punto entre $x$
...
En esta subsección
tratamos sólo el caso lineal, pero,
