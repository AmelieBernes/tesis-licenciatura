...
\begin{itemize}
	...
	$FP0(x)$, \TODO{Cambia este tipo de imágenes, pues las
	estabas graficando mal! Además, en realidad
	lo que ocurre es que tanto la de Fourier como la de espacios
	monofrecuenciales debería aproximar bien a la gráfica, pues ambas
	son las más cercanas de oscilacion omega !!! 
	El desfase parece ser siempre cero, checa las fórmulas del
	desfase; recuerda que, en este caso, las cw y sw son ortogonales!!}
	\begin{figure}[H]
			\sidecaption{
