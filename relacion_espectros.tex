...
\centering
    ...
    \includegraphics[scale = 1.2]{./estudios_espectrales/ejemplo_comparacion_1}
\end{figure}
...
\begin{itemize}
	...
	\begin{figure}[H]
			...
			discreto $\Pi_{P_{16, 3.39}}(x)$ (i.e. la gráfica naranja),
...
$f(t) = -1.5cos(2 \pi \cdot 5 t + 2\pi \cdot 0.2)$.
	\begin{figure}[H]
			\sidecaption{
			Como era de esperarse, la frecuencia principal de ambos
			espectros es $5$
			(y el valor de los 
			...
			\centering
			\includegraphics[scale = 0.5]{./estudios_espectrales/ejemplo_comparacion_4} 
		\end{figure}	
...
Recuerde que, para hacer un análisis espectral basado
...
\begin{figure}[H]
	\sidecaption{
	Fijando la cota superior de $Dom_{\omega}$
	como $n/2 =7/2$ y tomando $100$ puntos por unidad,
	obtenemos los siguientes espectros. Observe que el $\omega$
	cuyo coeficiente $\sigma_{7}(x, \omega)$ es más cercano a 
	$1$ es $0.24$, cercano a cero. Como se aprecia en las gráficas
	de abajo, un sinusoide de tal frecuencia parece aproximar bien
	la gráfica de $x$.
	\label{fig: ejemplo rango 1}
	}
	\centering
	\includegraphics[scale = 0.5]{./estudios_espectrales/ejemplo_rangoFrec_1} 
\end{figure}	

\begin{figure}[H]
	\sidecaption{
	Pongamos ahora como cota superior de 
	$Dom_{\omega}$
	a $n = 7$, y tomemos de nuevo $100$ puntos por unidad,
	\label{fig: ejemplo rango 1}. Observe que la $\omega$
	cuyo coeficiente $\sigma_{7}(x, \omega)$ es más cercano a 
	$1$ es, en este espectro, $6.76$. Note que, a pesar de que
	$\sigma_{7}(x, 0.24) < \sigma_{7}(x, 6.76)$, el sinusoide de frecuencia 
	$6.76$ que se grafica en naranja en la gráfica de abajo tiene muchas 
	oscilaciones que no parecen modelar bien la forma de la gráfica 
	de $x$. 
	}
	\centering
	\includegraphics[scale = 0.5]{./estudios_espectrales/ejemplo_rangoFrec_2} 
\end{figure}	
