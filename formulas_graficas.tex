...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 2 (figura 0)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 3 (figura 0)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 4 (figura 0)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 5 (figura 0)}
\end{figure}


\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 5 (figura 1)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 6 (figura 0)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 6 (figura 1)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 7 (figura 0)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 7 (figura 1)}
\end{figure}


\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 8 (figura 0)}
\end{figure}


\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD: dimensión 8 (figura 1)}
\end{figure}
