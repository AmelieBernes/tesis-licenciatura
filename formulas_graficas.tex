...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{bases/BLD_dimensión 2 (figura 0)}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD_dimensión 7 (figura 0)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD_dimensión 7 (figura 1)}
\end{figure}


\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD_dimensión 8 (figura 0)}
\end{figure}


\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bases/BLD_dimensión 8 (figura 1)}
\end{figure}
