...
%\input{apendice_BONhilbert} %esta sección me gusta, pero por el momento no la vamos a poner.

\input{apendice_gramSchm}
\input{apendice_anguloPuntoPlano}
%\input{apendice_sumOrt} %Esta parte de la teoría se usa sólo para lo que irá en la tesis de maestría, por lo que para esta tesis lo comento.

%\input{apendice_DFT} %Esto lo agregué al cap. de estudio espectral.