...
\usepackage{babel}
%\decimalpoint %TODO esto funcionaba, pero ahora da problemas...


\usepackage{mathtools}% http://ctan.org/pkg/mathtool
\usepackage{amsthm, amsmath, bm} 

%\usepackage{bbding} %para fuentes de flores:) no funciona...
...
\usepackage[colorlinks = true,linkcolor = violet, citecolor = blue]{hyperref}
