\chapter{Construcción canónica de las bases de Legendre discretas}
...
\subsection{Construcción de las BLD via ortogonalización de bases de espacios de polinomios discretos}
...
\marginnote{Abreviamos el 
nombre ``polinomio discreto de Legendre''
como ``PDL''.}
