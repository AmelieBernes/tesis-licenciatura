%Documento maestro.
\documentclass[a4paper,oneside,11pt]{article} %no funcionó tufle-book. Demasiada incompatibilidad con lo que tengo... mejor lo dejamos aspi. Original: extreport
...
\input{expresiones_legendre} %Sí compila.
\input{simetrias_codigos} %Sí compila.
\input{Teoria} %Sí compila.
\input{Notacion} %Sí compila.
